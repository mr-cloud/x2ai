model_memento_dir = 'model-memento/'
model_memento_postfix = '.mem'
score_file_name = 'score.txt'
recommendation_dir = 'recomms/'
...
classifier_ExtraTrees = 'ExtraTrees'
classifier_GradientBoosting = 'GradientBoosting'
